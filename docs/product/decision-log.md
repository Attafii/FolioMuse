...
## D-6 — Data flywheel and ranking feedback: action-weighted, saturation-limited, diversity-capped behavior-driven discovery
...
Related: ADR-0005, docs/design/design-tokens.md, AGENTS.md A§3 (skill gates) and A§5 (toolchain), docs/product/success-metrics.md (accessibility guardrail)
